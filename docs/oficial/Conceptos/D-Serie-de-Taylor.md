...
$$c_n = \frac{f^{(n)}(a)}{n!}$$
Esta fórmula sigue siendo válida incluso para ($n = 0$) si adoptamos la convención de que ($0! = 1$) y ($f^{(0)} = f$). En estos términos, hemos demostrado el teorema del inciso [[Series de Taylor y Maclaurin]]
